  ...
  return (
    <main className="section">
      <div className="max-w-md mx-auto card text-center">
        ...
        <h1 className="section-title mt-2">Booking received</h1>
        <p className="text-salon-dark/80 mt-2">
          Thanks, <span className="font-semibold">{info.first}</span>! We’ve saved your booking for{" "}
